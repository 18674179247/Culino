...
-- 角色-权限（user 基础权限）
INSERT INTO role_permissions (role_id, permission_id)
SELECT 2, id FROM permissions WHERE code IN ('recipe:create', 'recipe:edit_own', 'recipe:delete_own');

-- 食材分类
INSERT INTO ingredient_categories (name, sort_order) VALUES
('蔬菜', 1), ('肉类', 2), ('海鲜水产', 3), ('蛋奶', 4),
('豆制品', 5), ('主食', 6), ('水果', 7), ('干货', 8);

-- 常用调料
INSERT INTO seasonings (name, unit) VALUES
('盐', '克'), ('生抽', '毫升'), ('老抽', '毫升'), ('料酒', '毫升'),
('醋', '毫升'), ('白糖', '克'), ('蚝油', '毫升'), ('豆瓣酱', '克'),
('花椒', '克'), ('干辣椒', '个'), ('八角', '个'), ('桂皮', '块'),
('姜', '片'), ('蒜', '瓣'), ('葱', '根'), ('香油', '毫升'),
('胡椒粉', '克'), ('五香粉', '克'), ('淀粉', '克'), ('食用油', '毫升');

-- 标签
INSERT INTO tags (name, type, sort_order) VALUES
('川菜', 'cuisine', 1), ('粤菜', 'cuisine', 2), ('湘菜', 'cuisine', 3),
('鲁菜', 'cuisine', 4), ('江浙菜', 'cuisine', 5), ('西餐', 'cuisine', 6),
('日料', 'cuisine', 7), ('韩餐', 'cuisine', 8),
('麻辣', 'taste', 1), ('清淡', 'taste', 2), ('酸甜', 'taste', 3),
('咸鲜', 'taste', 4), ('香辣', 'taste', 5),
('快手菜', 'scene', 1), ('家常菜', 'scene', 2), ('宴客菜', 'scene', 3),
('早餐', 'scene', 4), ('夜宵', 'scene', 5), ('便当', 'scene', 6),
('减脂', 'diet', 1), ('高蛋白', 'diet', 2), ('素食', 'diet', 3);
